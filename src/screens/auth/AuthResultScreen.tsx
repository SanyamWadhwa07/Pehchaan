...
export function AuthResultScreen({ navigation, route }: Props): React.JSX.Element {
    ...
    <View style={styles.centered}>
      ...
      {!rejected ? (
        <>
          ...
          <Text style={styles.waiting}>{t('authResult.waitingConfirmation')}</Text>
...
const styles = StyleSheet.create({
  ...
  warn: { color: colors.warning, fontSize: 14, marginTop: 12, textAlign: 'center' },
  button: {
    marginTop: 32,
